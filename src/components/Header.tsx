interface Props {
  stats: { total: number; filtered: number; frameworks: number; domains: number };
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-400 to-accent-500 flex items-center justify-center font-bold text-white text-lg">
              AI
            </div>
            <div>
              ...
              <p className="text-xs text-slate-400">全网 Agent Skills 分类导航</p>
            </div>
          </div>
          <div className="flex items-center gap-4 text-xs text-slate-400">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>{stats.frameworks} 框架</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-green-400"></span>
              <span>{stats.domains} 领域</span>
            </div>
            <a
              href="https://github.com/lou1997/ai-skill-map"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-800/80 hover:bg-slate-700/80 transition-colors text-slate-300"
            >
